...
# ==========================================
# MUNDO 1: NF-e (COM SIDEBAR)
# ==========================================
if st.session_state.mundo == "NFe":
    # Forçar a sidebar a aparecer
    ...
    with m_col1:
        st.markdown('<div class="instrucoes-card"><h3>📖 Manual NF-e</h3><ol><li>Insira o CNPJ na lateral.</li><li>Arraste arquivos XML/ZIP.</li><li>Extração completa de 34 colunas.</li></ol></div>', unsafe_allow_html=True)
    with m_col2:
        st.markdown('<div class="instrucoes-card"><h3>🎯 Reforma 2026</h3><ul><li>Tags IBS/CBS inclusas.</li><li>Identificação de Entradas/Saídas.</li><li>Mapeamento Diamante de impostos.</li></ul></div>', unsafe_allow_html=True)
    ...
    else: st.warning("👈 Informe o CNPJ na lateral para começar.")

# ==========================================
# MUNDO 2: NFS-e (SEM SIDEBAR)
# ==========================================
else:
    # Forçar a sidebar a sumir
    ...
    with col1:
        st.markdown('<div class="instrucoes-card"><h3>📖 Passo a Passo NFS-e</h3><ol><li>Upload arquivos XML/ZIP.</li><li>Clique em Auditoria.</li><li>Analise divergências.</li></ol></div>', unsafe_allow_html=True)
    with col2:
        st.markdown('<div class="instrucoes-card"><h3>📊 Diagnóstico</h3><ul><li>ISS Próprio vs Retido.</li><li>Impostos Federais (PIS/COFINS).</li><li>Diagnóstico visual de notas.</li></ul></div>', unsafe_allow_html=True)
    ...
    if f_nfse and st.button("🚀 INICIAR AUDITORIA FISCAL"):
        ...
        if dados_nfse:
            ...
            with pd.ExcelWriter(out_nfse, engine='xlsxwriter') as writer:
                df_nfse.to_excel(writer, index=False, sheet_name='Auditoria_NFSe')
