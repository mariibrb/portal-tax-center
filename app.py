...
# --- CSS PREMIUM (UI UNIFICADA + HACK DE SIDEBAR) ---
st.markdown("""
    <style>
...
# --- LÓGICA DE NAVEGAÇÃO ---
# Criamos as abas e verificamos qual está selecionada
tab_nfe, tab_nfse = st.tabs(["💎 PORTAL TAX NF-e", "📑 PORTAL TAX NFS-e"])

# --- ABA NF-e (MATRIZ FISCAL) ---
with tab_nfe:
...
# --- ABA NFS-e (AUDITORIA FISCAL) ---
with tab_nfse:
    # HACK CSS PARA SUMIR A SIDEBAR
